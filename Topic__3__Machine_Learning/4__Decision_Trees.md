...
### 🧠 **PART 6: Ensemble Methods** *(Advanced Level - 10 minutes)*

#### 6.1 Random Forests

> A **Random Forest** is a collection of Decision Trees trained on random subsets of the data and features.

> Predictions are made by **majority vote** (classification) or **average** (regression).

> It solves the overfitting problem and improves generalization.

#### 6.2 Gradient Boosted Trees

> Instead of training trees independently, **Gradient Boosting** trains them sequentially.
